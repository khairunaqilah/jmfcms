                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <div class="booking-form">
                                ...
                                <h2 class="text-center mb-lg-3 mb-2">Edit Student </h2>
                                @foreach($students as $st)
                                <form action="{{ route('students.update',$st->id) }}" method="POST" >
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input type="date" name="dob"  class="form-control"   value="{{$st->dob}}" readonly>
                                            
                                        </div>
                                        <div class="col-lg-6 col-12">
                                        <input type="email" name="email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"   class="form-control"value="{{$st->email}}" >
                                        </div>

                                        <div class="col-lg-6 col-12">
                                            <input type="string" name="nric"  pattern="[0-9]+" required size="12" class="form-control" value="{{$st->nric}}" readonly>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input  type="text"  name="gender" class="form-control" value="{{$st->gender}}" readonly>
                                            
                                        </div>
                                        <div class="col-lg-6 col-12">
                                            
                                            <input  type="text"  name="race" class="form-control" value="{{$st->race}}" readonly>
                                        </div>
                                      

                                        <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                            <button type="submit" class="form-control" id="submit-button">Update</button>
                                        </div>
                                    </div>
                                </form>
                                @endforeach
