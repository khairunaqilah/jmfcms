...
class FeeTrackerController extends Controller
{
    ...
    public function update(Request $request, $feetracker)
    {
        ...
        if ($request->hasFile('receipt')) {
            ...
            // sini bole letak utk notification teachers
            $message     = "hello world";
            $phone_no    = "0133047981";
            ...
            // utk $url ni xyah return apa2.. just terus ke page.. nnti dia akan auto send notification
            // variable atas tu qila boleh guna klau nak tuka no org lain or any message.
